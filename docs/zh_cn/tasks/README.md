...
任务文档使用统一结构：功能目标、前置条件、流程图、关键分支、选项、实现映射、限制和完成状态。
任务文档只描述流程与实现，不记录测试结果。

流程图展示当前代码中的页面流转，并不代表所有分支均已实测；验证日期、覆盖路径和待验证分支见
[验证与调试记录](../records/README.md)。
...
各任务的实机验证与覆盖状态见 [验证与调试记录](../records/README.md)，与本目录文档一一对应。
